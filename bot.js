...
// ============================================================
// Handlers - سيتم تمريرها من index.js
// ============================================================
...
function ensureDatabaseShape() {
    ...
    if (!Array.isArray(db.gamePermissions)) {
        db.gamePermissions = [];
    }

    if (!Array.isArray(db.chainPermissions)) {
        db.chainPermissions = [];
    }

    if (typeof db.mazadCreator !== "string" && db.mazadCreator !== null) {
        db.mazadCreator = null;
    }
...
// ============================================================
// تحميل DB مباشرة عند تشغيل الملف
// ============================================================
...
// ============================================================
// Socket Management - المصدر الوحيد
// ============================================================
...
function registerEvents(sock, saveCreds) {
    ...
    // ========================================================
    // Group Participants - للحماية والإشراف
    // ========================================================
